...
class MessageController implements ContainerAwareInterface
{
    ...
    public function inboxAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('@App/Message/inbox.html.twig', array(
            'threads' => $threads,
        ));
    }
    ...
    public function threadAction($threadId)
    {
        ...
        if ($message = $formHandler->process($form)) {
            return new RedirectResponse($this->container->get('router')->generate('thread_view', array(
    ...
    public function newThread2Action(Request $request)
    {
        ...
        return $this->container->get('templating')->renderResponse('@App/Message/newThread2.html.twig', array(
            'form' => $form->createView(),
            'data' => $form->getData(),
            'username' => $username,
        ));
    ...
    public function deleteAction($threadId)
    {
        ...
        return new RedirectResponse($this->container->get('router')->generate('inbox'));
    }
